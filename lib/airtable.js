...
export const WeeklySnapshotsTable = base('WeeklySnapshots')
...
export function formatWeeklySnapshot(record) {
  return {
    id: record.id,
    weekOf: record.fields.WeekOf || '',
    locationId: record.fields.LocationId || '',
    locationName: record.fields.LocationName || '',
    // Quantitative
    totalOpen: record.fields.TotalOpen || 0,
    submitted: record.fields.Submitted || 0,
    identified: record.fields.Identified || 0,
    assigned: record.fields.Assigned || 0,
    solved: record.fields.Solved || 0,
    newThisWeek: record.fields.NewThisWeek || 0,
    resolvedThisWeek: record.fields.ResolvedThisWeek || 0,
    highUrgency: record.fields.HighUrgency || 0,
    // Qualitative
    pulseSummary: record.fields.PulseSummary || '',
    attentionFlags: record.fields.AttentionFlags || '',
    trendSignal: record.fields.TrendSignal || '',
  }
}
